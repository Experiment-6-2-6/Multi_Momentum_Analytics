...
1. **WSML**	iShares MSCI World Small Cap UCITS ETF USD (acc)
1. **VFEA**	Vanguard FTSE Emerging Mkts UCITS ETF USD (acc)
1. **IGIL**	iShares Global Inflation Lnked Govt Bonds UCITS ETF USD (acc)
1. **IGLN**	iShares Physical Gold ETC USD (no income)
...
9. I should have put the dates in this issue register. Without them I have lost a lot of explanatory power in this notebook. I missed the point that I am not the only stakeholder of this project anymore (readers are too). From now on I am going to put opening and closing dates in here.
...
*dm_crypto_with_ema_m.R* – basket of crypto, abs. momt. using EMA(30), monthly interval

*dm_crypto_with_ema_w.R* – basket of crypto, abs. momt. using EMA(30), weekly interval

*dm_crypto_with_zero_m.R* – basket of crypto, abs. momt. using 0, monthly interval

*dm_crypto_with_zero_w.R* – basket of crypto, abs. momt. using 0, weekly interval